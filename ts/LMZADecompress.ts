...
export class LMZADecompress {
  ...
  #byteArrayInputStream(this$static: any, buf: number[]) {
    this$static.buf = buf;
    this$static.pos = 0;
  ...
  #write_0(this$static: any, buf: number[], off: number, len: number) {
  ...
  /** ds */
  #init_0(this$static: any, input: any, output: any) {
    var decoder,
      hex_length = "",
      i,
      properties = [],
    ...
    this$static.chunker = this.#codeInChunks(
      decoder,
      input,
      output,
  ...
  #LZMAByteArrayDecompressor(this$static: any, data: any) {
  ...
  /** ds */
  #copyBlock(this$static: any, distance: number, len: number) {
  ...
  #create_5(this$static: any, windowSize: any) {
  ...
  #getByte(this$static: any, distance: number) {
    var pos = this$static._pos - distance - 1;
    if (pos < 0) {
      pos += this$static._windowSize;
    }
  ...
  #putByte(this$static: any, b: number) {
  ...
  /** ds */
  #chunker(this$static: any, decoder: any) {
  ...
  /** ds */
  #processDecoderChunk(this$static: any) {
  ...
  /** ds */
  #codeInChunks(this$static: any, inStream: any, outStream: any, outSize: any) {
  ...
  #codeOneChunk(this$static: any) {
    ...
    if (
      ...
      if (this$static.state < 7) {
        this$static.prevByte = this.#decodeNormal(
          decoder2,
          this$static.m_RangeDecoder
        );
      } else {
        this$static.prevByte = this.#decodeWithMatchByte(
          decoder2,
          this$static.m_RangeDecoder,
          this.#getByte(this$static.m_OutWindow, this$static.rep0)
        );
      }
      ...
      if (
        ...
        posSlot = this.#decode_0(
          this$static.m_PosSlotDecoder[this.#getLenToPosState(len)],
          this$static.m_RangeDecoder
        );
        if (posSlot >= 4) {
          ...
          if (posSlot < 14) {
            this$static.rep0 += this.#reverseDecode2(
            ...
            this$static.rep0 +=
              this.#decodeDirectBits(
                this$static.m_RangeDecoder,
                numDirectBits - 4
              ) << 4;
            this$static.rep0 += this.#reverseDecode(
      ...
      if (
        this.#compare(this.#fromInt(this$static.rep0), this$static.nowPos64) >=
          0 ||
  ...
  #setDecoderProperties(this$static: any, properties: any) {
  ...
  #setDictionarySize(this$static: any, dictionarySize: number) {
    if (dictionarySize < 0) {
      return 0;
    }
  ...
  #setLcLpPb(this$static: any, lc: any, lp: any, pb: any) {
    if (lc > 8 || lp > 4 || pb > 4) {
      return 0;
    }
  ...
  #create2(this$static: any, numPosStates: number) {
    for (
      ;
      this$static.m_NumPosStates < numPosStates;
      ++this$static.m_NumPosStates
    ) {
      this$static.m_LowCoder[this$static.m_NumPosStates] = this.#bitTreeDecoder(
        {},
        3
      );
      this$static.m_MidCoder[this$static.m_NumPosStates] = this.#bitTreeDecoder(
        {},
        3
      );
    }
  ...
  #decode2(this$static: any, rangeDecoder: any, posState: number) {
  ...
  #decoder$LenDecoder(this$static: any) {
  ...
  #create_0(this$static: any, numPosBits: any, numPrevBits: any) {
    var i, numStates;
    if (
  ...
  #getDecoder(this$static: any, pos: any, prevByte: any) {
  ...
  #decodeNormal(this$static: any, rangeDecoder: any) {
    var symbol = 1;
    do {
      symbol =
        (symbol << 1) |
  ...
  #decodeWithMatchByte(this$static: any, rangeDecoder: any, matchByte: any) {
    var bit,
      matchBit,
      symbol = 1;
    do {
  ...
  #decoder$LiteralDecoder$Decoder2(this$static: any) {
  ...
  /** ds */
  #bitTreeDecoder(this$static: any, numBitLevels: any) {
    this$static.NumBitLevels = numBitLevels;
    this$static.Models = this.#initDim(1 << numBitLevels);
    return this$static;
  }

  #decode_0(this$static: any, rangeDecoder: any) {
    var bitIndex,
      m = 1;
  ...
  #reverseDecode(this$static: any, rangeDecoder: any) {
    var bit,
      bitIndex,
      m = 1,
      symbol = 0;
  ...
  /** ds */
  #decodeBit(this$static: any, probs: number[], index: number) {
    var newBound,
      prob = probs[index];
  ...
  #decodeDirectBits(this$static: any, numTotalBits: number) {
    var i,
      t,
      result = 0;
  ...
  /** ds */
  decompress(byte_arr: number[] | Buffer, on_finish?: Function, on_progress?: Function) {
    var this$static: any = {},
      percent,
